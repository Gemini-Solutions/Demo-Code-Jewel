...
#  Scenario Outline: API To Request Role in Project requesting for QA when already QA (admin screen)
...
#      | adminApi5 | post   | 206             | adminScreen14 |
  ...
  Scenario Outline: API To Request Role in Project requesting for DEV when you already have dev access(admin
  screen)
    Given Setttt post array token endpoint and method "<endpoint>" and "<Method>" and "<SampleName>"
    Then Verify Status code <Expected_status>
    Examples:
