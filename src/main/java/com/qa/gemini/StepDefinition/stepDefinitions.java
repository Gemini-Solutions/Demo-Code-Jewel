...
public class stepDefinitions {
    ...
    public void UpdateSuite(String url, String method, String SampleName) throws Exception {
        status = utils.requestSuiteApi(url, method, utils.Gettoken2(), SampleName, "testsuiteioood").getStatus();
    }
    ...
    public void fileUpload7(String url) throws Exception {
        status = utils.TextUpload2(url, "Hello World", ProjectConfigData.getProperty("username2"), utils.Gettokennot2()).getStatus();
    }
